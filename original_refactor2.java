...
@@ -90,22 +93,24 @@ public static synchronized void updateConfig() {
...
-                .build();
     ...
     /** tryAddFeCache */
@@ -237,9 +242,6 @@ public Optional<LogicalSqlCache> tryParseSql(ConnectContext connectContext, Stri
     }
...
@@ -255,7 +257,7 @@ private boolean tablesOrDataChanged(Env env, SqlCacheContext sqlCacheContext) {
...
-            // some partitions have been dropped, or delete or update or insert rows into new partition?
             if (currentTableTime > cacheTableTime
                 ...
                 return true;
@@ -264,9 +266,7 @@ private boolean tablesOrDataChanged(Env env, SqlCacheContext sqlCacheContext) {
